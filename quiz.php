    ...
    <div class="content">
              ...
              <div class="content-grid">
                  <div id="quiz1" class="quiz" onclick="openquizbox()" >
                      ...
                      <div class="button" ><a href="quiz_questions.php?q=1&n=1">Start</div></a>
                  </div>
                  <div id="quiz2" class="quiz" onclick="openquizbox()" >
                      ...
                      <div class="button"><a href="quiz_questions.php?q=2?n=1">Start</div></a>
                  </div>
                  <div id="quiz3" class="quiz" onclick="openquizbox()" >
                      ...
                      <div class="button"><a href="quiz_questions.php?q=3?n=1">Start</div></a>
                  </div>
                  </div>
              </div>
              </div>
